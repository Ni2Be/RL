...
namespace Ai_Arena
{
	...
	public:
		...
		{
			//SNAKE
			m_enviroment = std::shared_ptr<I_Environment>(new Multi_Snake(20, 30));
			...
			//EIGHT PUZZLE
			//m_enviroment_2 = std::shared_ptr<I_Environment>(new Eight_Puzzle(3, 3, 90));
			//
	...
	protected:
		std::shared_ptr<I_Environment> m_enviroment;
		std::vector<std::shared_ptr<Actor>> m_actors;
		//std::thread m_environment_thread;

		std::shared_ptr<I_Environment> m_enviroment_2;
